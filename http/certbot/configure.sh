...
if [ -z "$2" ] || [ -z "$3" ]; then
  ...
  echo "Copy AWS policy file from https://certbot-dns-route53.readthedocs.io/en/stable/#sample-aws-policy-json"
  echo "Make sure to replace YOURHOSTEDZONEID with your zone"
